...
function updateFirst(event) {
  ...
  document.querySelectorAll("p,h1,h2,h3,li").forEach(function(p) {
    p.style.color = event.target.value;
    $('h5').html(event.target.value);
  });
}
...
$(document).ready(function() {
    ...
    $("#beigebg").click(function() {
        $("body").css("background-image", "none");
        $("body").css("background-color","#F5F5DC");
    });
    $("#picbg").click(function() {
        $("body").css("background-image","url(http://www.planwallpaper.com/static/images/background-wallpapers-2.jpg)");
    });
});
